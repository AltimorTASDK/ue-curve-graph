...
python ue_curve_graph.py "$curve_dir/SkiSteeringInfluence.json"                  -o                        --x-suffix=" cm/s" --y-min=0 --y-max=100 --y-scale=100 --y-suffix="%"
python ue_curve_graph.py "$curve_dir/SkiSteeringInfluenceHeavy.json"             -o                        --x-suffix=" cm/s" --y-min=0 --y-max=100 --y-scale=100 --y-suffix="%"
python ue_curve_graph.py "$curve_dir/SkiSteeringInfluenceLight.json"             -o                        --x-suffix=" cm/s" --y-min=0 --y-max=100 --y-scale=100 --y-suffix="%"
python ue_curve_graph.py "$curve_dir/SkiSteeringInfluenceMedium.json"            -o                        --x-suffix=" cm/s" --y-min=0 --y-max=100 --y-scale=100 --y-suffix="%"
